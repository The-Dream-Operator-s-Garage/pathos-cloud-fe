...
// element flyout dials it on its node face's wrapper (this panel left that
// box on 2026-08-17; it capped the quoted panel at a fifth of the box while
// it lived there) — exactly as `--media-max-h` works.
