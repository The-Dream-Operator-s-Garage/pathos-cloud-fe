...
// in `_tokens.scss` § INDIGO, THE POST WINDOW'S FAMILY (cyan's until 2026-09-07). ──
//
...
.maker-dock {
  ...
  // ⚠ THE FAMILY MOVED ON 2026-09-07 (user ask: "posts -> indigo") — the levels named here
  // are indigo — the feed surface's own family's now; the dials above them follow in `_tokens.scss`.
  --dock-rule-strong: var(--indigo-8);
...
.dock-tab:hover { color: var(--indigo-8); }
